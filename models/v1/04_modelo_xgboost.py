...
# Carregar dataset limpo (Caminho subindo 2 níveis até notebooks)
...
# Salvar modelo (já estamos dentro da pasta models/v1/)
model_path = 'xgboost_atraso_v1.pkl'
joblib.dump(model, model_path)

# Salvar lista de features na ordem exata (o backend precisa disso)
features_path = 'features_order.txt'
