...
from backend.utils.exceptions import OlistAPIException
...
async def startup_event():
    ...
    from backend.chatbot.config import CHATBOT_ENABLED
    if CHATBOT_ENABLED:
...
async def shutdown_event():
    ...
    from backend.chatbot.mcp_client import mcp_client
    from backend.chatbot.openrouter_client import close_client
