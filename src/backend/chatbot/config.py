...
MAX_TOOL_ITERATIONS = int(os.getenv("CHATBOT_MAX_TOOL_ITERATIONS", "5"))
MAX_TOOL_RESULT_CHARS = int(os.getenv("CHATBOT_MAX_TOOL_RESULT_CHARS", "4000"))
MAX_CONSECUTIVE_TOOL_ERRORS = int(os.getenv("CHATBOT_MAX_CONSECUTIVE_TOOL_ERRORS", "3"))
